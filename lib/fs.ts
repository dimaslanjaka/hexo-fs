...
export function writeFile(path: string, data?: string | NodeJS.ArrayBufferView, options?: WriteFileOptions) {
  if (!path) throw new TypeError('path is required!');
